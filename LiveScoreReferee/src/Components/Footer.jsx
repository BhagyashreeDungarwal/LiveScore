...
const Footer = () => {
  return (
    ...
    <footer className="footer">
      ...
      <section className="py-3 pt-xl-8 text-light">
        <div className="container overflow-hidden">
          <div className="row gy-2 gy-lg-0 justify-content-xl-between">
      ...
      <div className=" pt-4 pt-md-5 pt-xl-8 pb-2 text-light">
        <div className="container overflow-hidden">
          <div className="row gy-4 gy-md-0">
            <div className="col-xs-12 col-md-7 order-1 order-md-0">
              ...
              <div className="credits text-secondary text-center text-md-start mt-2 fs-7">
                Built by <a href="https://bootstrapbrain.com/" className="link-secondary text-decoration-none">LiveScore Team</a> with <span className="text-primary">&#9829;</span>
              </div>
            </div>
