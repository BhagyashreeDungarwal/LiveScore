...
import { Button, Dialog, DialogActions, DialogContent, DialogTitle, Slide, TextField, Grid, InputAdornment, Typography } from '@mui/material';
        ...
        <form onSubmit={handleSubmit}>
          <DialogContent>
            <Grid container spacing={2}>
              ...
              <Grid item sx={12} xl={12} md={12} lg={12} xs={12}>
                <Typography variant="body" color="initial">{msg}</Typography>
              </Grid>
            </Grid>
          </DialogContent>
          <DialogActions>
